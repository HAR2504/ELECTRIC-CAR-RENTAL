    ...
    <body background="loginimage.jpeg" style="background-size:100% 700px;background-attachment: fixed;">
        <%
            ...
            try
            {
                ...
                PreparedStatement st=cn.prepareStatement("select * from employee where email_id=?");
                st.setString(1, uid);
                ...
                <div class="profile-form">
                    ...
                    <div class="login-password-htm">
                        ...
                        <div class="group">
                            ...
                            <input name="Mobile Number" type="text" class="input" placeholder="<%=rs.getString(4)%>">
                        ...
                        <div class="group">
                            ...
                            <input name="user" type="text" class="input" placeholder="<%=rs.getString(5)%>">

                        </div>
                            <div class="group">

                            <label for="user" class="label" style="color: white">Date of Joining</label>

                            <input name="user" type="text" class="input" placeholder="<%=rs.getString(6)%>">
