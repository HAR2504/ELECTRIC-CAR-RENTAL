    ...
    <body>
        <%
            ...
            try
            {
                ...
                PreparedStatement st=cn.prepareStatement("select * from driver");
...
<ul>
   <li><a href="profile.html">Profile</a></li>
                ...
                <li><a href="ardriver.html">Driver</a></li>
</ul>
</div>
<script>
...
<div style="padding: 130px 20px 15px 250px; ">
